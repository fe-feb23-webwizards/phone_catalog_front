    ...
    <footer className="footer">
      <div className="footer__wrap">
        <div className="footer__logo logo">
          <img className="logo__img" src="../../stylesScss/images/FooterLogo.svg" alt="company logo" />
        </div>
        ...
        <div className="footer__lift lift">
          ...
          <button
            ...
            onClick={backToTop}
          >
            <img className="lift__buttonImg" src="../../stylesScss/images/FooterLogo.svg" alt="up arrow" />
          </button>
        </div>
      </div>
    </footer>
